...
|---|---|---|
| ЕИС | Ручной RSS-поиск по фразе; 44/223‑ФЗ, НМЦК, дата, этапы закупки и проверенная дополнительная информация; до 10 страниц; сохранение полного набора условий и повторный запуск одной кнопкой; релевантность по предмету закупки | Полный каталог ЕИС, регион/ОКПД2 без RSS-ссылки, monitoring |
