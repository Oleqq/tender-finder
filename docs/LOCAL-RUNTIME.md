...
3. При необходимости задайте 44‑ФЗ/223‑ФЗ, НМЦК, период публикации и этапы
...
6. В блоке «Сохранённые поиски» задайте понятное название и сохраните текущую
   ...
   сохранённые значения в форму.
7. Для региона и ОКПД2 раскройте «Расширенные фильтры ЕИС» и вставьте
