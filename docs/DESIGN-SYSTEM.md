...
| Tender UI | local MVP ЕИС: поиск, все/любое/точная фраза, минус-слова, видимые причины совпадения, текущая выдача/история и её сортировка, decision-detail, полноценные карточки мониторингов с ручным запуском, статистикой и копированием условий, рабочая лента с URL-фильтрами/поиском/сортировкой/пагинацией, inline-редактированием и сохранёнными представлениями, обзор ближайших действий, настройки и локальный предпросмотр уведомлений, именованные сохранённые запросы, «только новые», 44/223‑ФЗ, НМЦК, даты, регион/ОКПД2, этапы, сравнение 2–5 карточек, personal states, массовые статусы/теги/даты, заметки, CSV/XLSX и явное публичное обогащение одной карточки | реальная Telegram-доставка после включения фонового мониторинга |
