...
Поиск можно сохранить под своим названием вместе со всеми условиями ЕИС и
повторно запустить одной кнопкой; интерфейс показывает время и счётчики
последнего запуска. Встроенные условия включают закон, НМЦК, период публикации,
этап закупки и проверенные признаки из блока «Дополнительная информация» ЕИС.
